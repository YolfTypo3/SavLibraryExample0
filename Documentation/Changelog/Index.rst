...
0.1.1    - New currency field added in the dates and integer folders.
...
0.0.5    - Extension regenerated with the latest version of the SAV Library
           Kickstarter (small changes in ext_emconf.php).
0.0.4    - Documentation updated to the new documentation template (doc_template
           1.6.2).
